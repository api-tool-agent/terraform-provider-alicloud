...
description: |-
  Provides a Alicloud File Storage (NAS) Log Analysis resource.
---
...
* `create` - (Defaults to 5 mins) Used when create the Log Analysis.
* `delete` - (Defaults to 5 mins) Used when delete the Log Analysis.
